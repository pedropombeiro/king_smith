...
class DistanceSensor(WalkingPadEntity, SensorEntity):
    ...
    def __init__(
        ...
        self._state = 0.0
        super().__init__(f"{treadmillName}_distance", walking_pad_api, coordinator)
...
class TimeSensor(WalkingPadEntity, SensorEntity):
    ...
    def __init__(
        ...
        self._state = 0
        super().__init__(f"{treadmillName}_time", walking_pad_api, coordinator)
...
class SpeedSensor(WalkingPadEntity, SensorEntity):
    ...
    def __init__(
        ...
        self._state = 0.0
        super().__init__(f"{treadmillName}_speed", walking_pad_api, coordinator)
...
class StepsSensor(WalkingPadEntity, SensorEntity):
    ...
    def __init__(
        ...
        self._state = 0
        super().__init__(f"{treadmillName}_steps", walking_pad_api, coordinator)
...
class StepCadenceSensor(WalkingPadEntity, SensorEntity):
    ...
    def __init__(
        ...
        self._state = 0.0
        super().__init__(f"{treadmillName}_step_cadence", walking_pad_api, coordinator)
...
class TotalDistanceSensor(WalkingPadEntity, RestoreSensor):
    ...
    def __init__(
        ...
        self._state = 0.0
        self._last = 0
        super().__init__(f"{treadmillName}_total_distance", walking_pad_api, coordinator)
...
class TotalTimeSensor(WalkingPadEntity, RestoreSensor):
    ...
    def __init__(
        ...
        self._state = 0
        self._last = 0
        super().__init__(f"{treadmillName}_total_time", walking_pad_api, coordinator)
...
class TotalStepsSensor(WalkingPadEntity, RestoreSensor):
    ...
    def __init__(
        ...
        self._state = 0
        self._last = 0
        super().__init__(f"{treadmillName}_total_steps", walking_pad_api, coordinator)
